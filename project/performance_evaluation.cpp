...
int main() {
	// Define data.
	projectData data = projectData("../project/input/aachen_000029_000019_test/aachen_000029_000019", 3);
	...
	pointcloudVo.pointCloud2ply("../project/output/main/3dcloud_verticalObjects.ply");
	cout << "Exported." << endl;
